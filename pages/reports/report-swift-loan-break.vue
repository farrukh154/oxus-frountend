<template>
  <v-card class="pa-2 ma-2">
    <v-card-title>Swift Loan Breakdown</v-card-title>
    <v-form ref="form">
      <v-row>
        <v-col cols="4">
...
const REPORT_UID = 'report-swift-loan-break'
...
const loadReport = async () => {
  ...
  try {
    ...
    const res = await apiClient.post('/reports/report-swift-loan-break/', bodyData)
