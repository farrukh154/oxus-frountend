<template>
  <v-card class="pa-2 ma-2">
    <v-card-title>LLP Per Loan</v-card-title>
    <v-form ref="form">
      <v-row>
        <v-col cols="4">
...
const REPORT_UID = 'report-abacus-llp-per-loan'
...
const loadReport = async () => {
  ...
  try {
    ...
    const res = await apiClient.post('/reports/report-abacus-llp-per-loan/', bodyData)
