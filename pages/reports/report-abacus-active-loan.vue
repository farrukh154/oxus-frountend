<template>
  <v-card class="pa-2 ma-2">
    <v-card-title>Active Loan</v-card-title>
    <v-form ref="form">
      <v-row>
        <v-col cols="4">
...
const REPORT_UID = 'report-abacus-active-loan'
...
const loadReport = async () => {
  ...
  try {
    ...
    const res = await apiClient.post('/reports/report-abacus-active-loan/', bodyData)
